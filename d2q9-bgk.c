  ...
  for (int jj = 0; jj < params.ny; jj++) {
    ...
    ** respecting periodic boundary conditions (wrap around) */
      ...
      /* don't consider occupied cells */
        ...
        /* relaxation step */
        cells_new[ii + jj * params.nx].speeds[0] = cells[ii + jj * params.nx].speeds[0] + params.omega * (d_equ[0] - cells[ii + jj * params.nx].speeds[0]);
        cells_new[ii + jj * params.nx].speeds[1] = cells[x_w + jj * params.nx].speeds[1] + params.omega * (d_equ[1] - cells[x_w + jj * params.nx].speeds[1]);
        cells_new[ii + jj * params.nx].speeds[2] = cells[ii + y_s * params.nx].speeds[2] + params.omega * (d_equ[2] - cells[ii + y_s * params.nx].speeds[2]);
        cells_new[ii + jj * params.nx].speeds[3] = cells[x_e + jj * params.nx].speeds[3] + params.omega * (d_equ[3] - cells[x_e + jj * params.nx].speeds[3]);
        cells_new[ii + jj * params.nx].speeds[4] = cells[ii + y_n * params.nx].speeds[4] + params.omega * (d_equ[4] - cells[ii + y_n * params.nx].speeds[4]);
        cells_new[ii + jj * params.nx].speeds[5] = cells[x_w + y_s * params.nx].speeds[5] + params.omega * (d_equ[5] - cells[x_w + y_s * params.nx].speeds[5]);
        cells_new[ii + jj * params.nx].speeds[6] = cells[x_e + y_s * params.nx].speeds[6] + params.omega * (d_equ[6] - cells[x_e + y_s * params.nx].speeds[6]);
        cells_new[ii + jj * params.nx].speeds[7] = cells[x_e + y_n * params.nx].speeds[7] + params.omega * (d_equ[7] - cells[x_e + y_n * params.nx].speeds[7]);
        cells_new[ii + jj * params.nx].speeds[8] = cells[x_w + y_n * params.nx].speeds[8] + params.omega * (d_equ[8] - cells[x_w + y_n * params.nx].speeds[8]);
