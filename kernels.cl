...
__kernel void accelerate_flow(
    __global float* cells_speeds_0,
    __global float* cells_speeds_1,
    __global float* cells_speeds_2,
    __global float* cells_speeds_3,
    __global float* cells_speeds_4,
    __global float* cells_speeds_5,
    __global float* cells_speeds_6,
    __global float* cells_speeds_7,
    __global float* cells_speeds_8,
...
__kernel void timestep(
    ...
    __global float* cells_speeds_7,
    __global float* cells_speeds_8,
    __global float* cells_new_speeds_0,
    __global float* cells_new_speeds_1,
    __global float* cells_new_speeds_2,
    __global float* cells_new_speeds_3,
    __global float* cells_new_speeds_4,
    __global float* cells_new_speeds_5,
    __global float* cells_new_speeds_6,
    __global float* cells_new_speeds_7,
    __global float* cells_new_speeds_8,
    __global int* obstacles,
