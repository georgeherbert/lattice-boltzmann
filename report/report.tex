...
\begin{table}[htbp]
  ...
  \begin{tabular}{l | l  l  l} 
      ...
      Grid Size&Time (s)&Original&Vectorized\\
      \hline
      $128 \times 128$&\texttt{ 0.70}&\texttt{}&\texttt{}\\
      $128 \times 256$&\texttt{ 0.81}&\texttt{}&\texttt{}\\
      $256 \times 256$&\texttt{ 2.60}&\texttt{}&\texttt{}\\
      $1024 \times 1024$&\texttt{14.01}&\texttt{}&\texttt{}\\
      \hline
    \end{tabular}
  \end{center}
\end{table}
...
\begin{figure}
  ...
  \begin{tikzpicture}
    ...
    \addplot[color = red, mark = x]coordinates{
      (0,35.1)(10,27.5)(20,32)(30,37.8)(40,44.6)(60,61.8)(80,83.8)(100,114)
    };
    \addlegendentry{$128\times256$}
    \addplot[color = green, mark = x]coordinates{
      (0,45.1)(10,57.5)(20,62)(30,37.8)(40,64.6)(60,61.8)(80,83.8)(100,114)
    };
    \end{axis}
  \end{tikzpicture}
  \caption{Scaling}
