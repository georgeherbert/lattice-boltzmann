...
\begin{table}[htbp]
    \begin{center}
    \caption{Total times of the original code}\label{tab:original}
    \begin{tabular}{l | l} 
        \hline\hline
...
\begin{table}[htbp]
  \begin{center}
  \caption{Total times after compiler changes}\label{tab:compiler_changes}
  \begin{tabular}{l | l} 
      \hline\hline
      Test Case Size&Time (s)\\
      \hline
...
\begin{table}[htbp]
  \begin{center}
  \caption{Total times after loop fusion and pointer swap}\label{tab:loop_fusion_pointer_swap}
  \begin{tabular}{l | l} 
      \hline\hline
      Test Case Size&Time (s)\\
      \hline
...
\begin{table}[htbp]
  \begin{center}
  \caption{Total times after arithmetic improvements}\label{tab:arithmetic_improvements}
  \begin{tabular}{l | l} 
      \hline\hline
      Test Case Size&Time (s)\\
      \hline
...
\begin{table}[htbp]
    \begin{center}
    \caption{Total time after vectorization}\label{tab:vectorized}
    \begin{tabular}{l | l} 
        \hline\hline
        Test Case Size&Time (s)\\
        \hline
