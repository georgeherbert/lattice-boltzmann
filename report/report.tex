...
These changes to the compiler provided a reasonable performance boost, as shown in Figure \ref{tab:compiler_changes}.
...
Decreasing the number of memory accesses provided further performance improvements, as shown in Figure \ref{tab:loop_fusion_pointer_swap}.
...
These small arithmetic improvements provided a small boost to performance, as shown in Figure \ref{tab:arithmetic_improvements}.
...
Vectorization provided the largest performance improvement of any optimisation that I had implemented to this point, as shown in Figure \ref{tab:vectorized}.
...
\begin{figure}[htpb]
  ...
  \begin{tikzpicture}
    ...
    \end{axis}
  \end{tikzpicture}
  \caption{Speedup curves for NUMA-aware implementation}
\end{figure}
