...
It then stored the reciprocal of this value in \texttt{params.num\_non\_obstacles\_r}, which it multiplied with \texttt{tot\_u} to compute each timestep's average velocity.
