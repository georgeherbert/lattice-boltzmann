...
\subsection{Intel C Compiler Classic (ICC)}

I hypothesised that compiling with ICC instead of GCC would produce an executable better optimised for BC4's Intel compute nodes.
