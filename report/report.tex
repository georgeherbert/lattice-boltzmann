...
Compared to my vectorized implementation, the arithmetic intensity is identical, whereas the performance increased by a factor of 16.60.
...
I produced a separate implementation of LBM in Go to compare to the C implementation.
