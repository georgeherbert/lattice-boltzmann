...
My MPI implementation scaled better for the smaller size, whereas my OpenMP implementation initially scaled slightly better for the larger size.
...
The OpenMP overhead was largely constant, regardless of the grid size, whereas the MPI overhead was approximately proportional to the width of the grid.
