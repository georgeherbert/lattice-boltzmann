...
\begin{table}[htbp]
  ...
  \begin{tabular}[t]{l | l l} 
      ...
      Grid Size&Time (s)&Speedup\\
      \hline
      $128 \times 128$&\texttt{ 0.66}&\texttt{}\\
      $128 \times 256$&\texttt{ 0.66}&\texttt{}\\
      $256 \times 256$&\texttt{ 1.90}&\texttt{}\\
      $1024 \times 1024$&\texttt{ 3.15}&\texttt{}\\
      $2048 \times 2048$&\texttt{12.67}&\texttt{1.29}\\
      \hline
    \end{tabular}
  \end{center}
\end{table}
